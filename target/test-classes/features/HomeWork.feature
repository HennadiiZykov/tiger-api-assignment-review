...
And request {"email": "22Hennadii.Zykov@gmail.com","firstName": "Hennadii","lastName": "Zykov","title": "Mr.","gender": "MALE","maritalStatus": "SINGLE","employmentStatus": "QA tester","dateOfBirth": "1983-02-27"}
...
And assert errorMessage == "Account with Email 22Hennadii.Zykov@gmail.com is exist"
...
And param primaryPersonId = 1882
And request {"make": "Toyota1","model": "Rav4","year": "2006","licensePlate": "1234"}
And header Authorization = "Bearer " + genToken
When method post
Then status 201
And print response
...
And param primaryPersonId = 1882
And request {"addressType": "3060","addressLine2": "Ocean Avenue","city": "Brooklyn","state": "NY","postalCode": "11235","countryCode": "Cell Phone","current": true}
And header Authorization = "Bearer " + genToken
When method post
Then status 201
And print response
